...
public class SQLQueries {
    ...
    public static final String RETRIEVE_FLOW_ID_IDENTIFIER =
            "SELECT FLOW_ID_IDENTIFIER FROM IDN_AUTH_REST_FLOW WHERE FLOW_ID = ?;";

    public static final String UPDATE_FLOW_ID_DATA = "UPDATE IDN_AUTH_REST_FLOW SET FLOW_ID_STATE=?, TIME_GENERATED=?, " +
            "EXPIRY_TIME=?, IS_AUTH_FLOW_COMPLETED=?, SP_APP_ID=?, SP_TENANT_ID=?, LOGGED_USER_CLAIM=? " +
            "WHERE FLOW_ID_IDENTIFIER=?;";
