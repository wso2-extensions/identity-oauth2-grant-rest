    ...
    public void addFlowIdData(FlowIdDO flowIdDO) throws AuthenticationException {
        ...
        try (Connection connection = IdentityDatabaseUtil.getDBConnection(true)) {
            ...
            try (PreparedStatement prepStmt1 = connection.prepareStatement(SQLQueries.ADD_FLOW_ID);
                ...
                prepStmt1.setString(9, flowIdDO.getLoggedUserClaim());
        ...
        try (Connection connection = IdentityDatabaseUtil.getDBConnection(false);
            ...
            try (ResultSet resultSet = prepStmt.executeQuery()) {
                if (resultSet.next()) {
                    ...
                    flowIdDO.setLoggedUserClaim(resultSet.getString(Constants.DB_FIELD_LOGGED_USER_CLAIM));
    ...
    public void addRefreshedFlowIdData(String prevFlowIdIdentifier, FlowIdDO flowIdDO) throws AuthenticationException {
        ...
        try (Connection connection = IdentityDatabaseUtil.getDBConnection(true)) {
            ...
            try (PreparedStatement prepStmt1 = connection.prepareStatement(SQLQueries.ADD_FLOW_ID);
                ...
                prepStmt2.setString(2, prevFlowIdIdentifier);

                prepStmt3.setString(1, flowIdDO.getFlowIdIdentifier());
                prepStmt3.setString(2, prevFlowIdIdentifier);
