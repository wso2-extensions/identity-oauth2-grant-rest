...
import org.wso2.carbon.identity.oauth2.grant.rest.endpoint.factories.InitAuthenticatorApiServiceFactory;
...
public class InitAuthenticatorApi  {
    ...
    private final InitAuthenticatorApiService delegate = InitAuthenticatorApiServiceFactory.getInitAuthenticatorApi();
