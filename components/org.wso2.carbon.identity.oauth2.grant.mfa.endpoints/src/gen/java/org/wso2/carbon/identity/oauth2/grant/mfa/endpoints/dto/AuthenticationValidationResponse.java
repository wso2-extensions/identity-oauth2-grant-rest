...
public class AuthenticationValidationResponse {
     ...
     **/
    public AuthenticationValidationResponse isValidPassword(Boolean isValidPassword) {
     ...
     **/
    public AuthenticationValidationResponse userId(String userId) {
    ...
    /**
     **/
    public AuthenticationValidationResponse authenticatedSteps(Object authenticatedSteps) {
    ...
    /**
     **/
    public AuthenticationValidationResponse authenticationSteps(Object authenticationSteps) {
    ...
    @ApiModelProperty(example =
            "\"[{\\\"stepNo\\\":1,\\\"authenticator\\\":[{\\\"authenticatorName\\\":\\\"BasicAuthenticator\\\",\\\"" +
                    "isMandatory\\\":true}]},{\\\"stepNo\\\":2,\\\"authenticator\\\":[{\\\"authenticatorName\\\":\\\"" +
                    "EmailOTP\\\",\\\"isMandatory\\\":true},{\\\"authenticatorName\\\":\\\"SMSOTP\\\",\\\"" +
                    "isMandatory\\\":false}]}]\"")
    ...
    public AuthenticationValidationResponse setAutheticatorStepDetails
    ...
    /**
     **/
    public AuthenticationValidationResponse failureReason(AuthenticationValidationFailureReason failureReason) {
    ...
    public boolean equals(Object o) {
        ...
        AuthenticationValidationResponse authValidationResponse = (AuthenticationValidationResponse) o;
        return Objects.equals(this.isValidPassword, authValidationResponse.isValidPassword) &&
                Objects.equals(this.userId, authValidationResponse.userId) &&
                Objects.equals(this.flowId, authValidationResponse.flowId) &&
                Objects.equals(this.isAuthFlowCompleted, authValidationResponse.isAuthFlowCompleted) &&
                Objects.equals(this.authenticatedSteps, authValidationResponse.authenticatedSteps) &&
                Objects.equals(this.authenticationSteps, authValidationResponse.authenticationSteps) &&
                Objects.equals(this.nextStep, authValidationResponse.nextStep) &&
                Objects.equals(this.failureReason, authValidationResponse.failureReason);
    }
    ...
    public int hashCode() {
        ...
        return Objects.hash
                (isValidPassword, userId, flowId, isAuthFlowCompleted, authenticatedSteps, authenticationSteps,
                        nextStep, failureReason);
    }
