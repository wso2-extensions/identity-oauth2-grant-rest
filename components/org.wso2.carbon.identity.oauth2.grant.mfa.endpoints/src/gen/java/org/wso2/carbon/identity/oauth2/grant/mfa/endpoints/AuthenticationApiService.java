...
public interface AuthenticationApiService {
    ...
    Response initializePost(AuthenticationInitializationRequest authInitializationRequest, String userTenantDomain);
    Response authenticatePost(UserAuthenticationRequest userAuthenticationRequest, String userTenantDomain);
    Response getSPAuthenticationSteps(AuthenticationStepsRequest authenticationStepsReques);
}
