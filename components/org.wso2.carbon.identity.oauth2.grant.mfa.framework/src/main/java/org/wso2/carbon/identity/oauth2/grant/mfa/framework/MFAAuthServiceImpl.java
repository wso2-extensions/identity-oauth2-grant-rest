...
public class MFAAuthServiceImpl implements MFAAuthService {
    ...
    public MFAInitializationResponseDTO initializeMFA(String userId, String authenticator, String mfaToken)
        ...
        if (isValidMfaToken(mfaTokenDO) && validateUser(mfaTokenDO, userId)) {
            ...
            if (authenticator.equals(Constants.AUTHENTICATOR_NAME_SMSOTP)) {
                GenerationResponseDTO mfaResponseDTO =
                        (GenerationResponseDTO) getAuthenticatorServiceGenerationResponse(getAuthenticatorService(authenticator),
                ...
                mfaResponseDTO =
                        (org.wso2.carbon.extension.identity.emailotp.common.dto.GenerationResponseDTO) getAuthenticatorServiceGenerationResponse(getAuthenticatorService(authenticator), userId, IdentityTenantUtil.getTenantDomain(authContext.getUserTenantId()));
    ...
    public MFAValidationResponseDTO validateMFA(String userId, String mfaToken, String authenticator, String otp)
        ...
        if (isValidMfaToken(mfaTokenDO) && validateUser(mfaTokenDO, userId)) {
            ...
            if (authenticator.equals(Constants.AUTHENTICATOR_NAME_SMSOTP)) {
                ...
                mfaResponseDTO =
                        (ValidationResponseDTO) getAuthenticatorServiceValidationResponse(getAuthenticatorService(authenticator),
                ...
                mfaResponseDTO =
                        (org.wso2.carbon.extension.identity.emailotp.common.dto.ValidationResponseDTO) getAuthenticatorServiceValidationResponse(getAuthenticatorService(authenticator), mfaToken, userId, IdentityTenantUtil.getTenantDomain(authContext.getUserTenantId()), otp);
     ...
     * @throws MFAAuthException if any server or client error occurred.
     */
    private Object getAuthenticatorServiceGenerationResponse (Object authenticatorService, String userId,
                                                              String userTenantDomain) throws MFAAuthException {
     ...
     * @throws MFAAuthException if any server or client error occurred.
     */
    private Object getAuthenticatorServiceValidationResponse (Object authenticatorService, String mfaToken,
                                                              String userId, String userTenantDomain, String otp)
            throws MFAAuthException {
