...
public interface AuthenticationListener {
	 ...
	 */
	boolean doPreAuthenticate(AuthRestAuthenticationContext authContext) throws AuthenticationException;
	 ...
	 * @throws AuthenticationException if any server or client error occurred.
	 */
	boolean doPostAuthenticate(AuthRestAuthenticationContext authContext) throws AuthenticationException;
